...
import pic from "../../public/7d7574b6-8005-424f-9d94-d4485ad65b21.jpg";
        ...
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 mt-12 md:mt-24 space-y-2 order-2 md:order-1">
            ...
            <p className="text-sm md:text-md text-justify">
              ...
              My expertise includes MongoDB, ExpressJs, ReactJs, NodeJs and I strive to stay ahead of the curve in this ever-evolving field. Let's collaborate and code the future together!
            </p>
            <br />
            {/* social media icons */}
